...
class TCLIService_RenewDelegationToken_result
{
    ...
    static public $_TSPEC = array(
        0 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TRenewDelegationTokenResp',
        ),
    );

    /**
     * @var \ThriftGenerated\TRenewDelegationTokenResp
     */
    public $success = null;
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \ThriftGenerated\TRenewDelegationTokenResp();

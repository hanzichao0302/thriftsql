...
class TCLIService_CancelDelegationToken_result
{
    ...
    static public $_TSPEC = array(
        0 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TCancelDelegationTokenResp',
        ),
    );

    /**
     * @var \ThriftGenerated\TCancelDelegationTokenResp
     */
    public $success = null;
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \ThriftGenerated\TCancelDelegationTokenResp();

...
class TColumnValue
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TBoolValue',
        ),
        2 => array(
            'var' => 'byteVal',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TByteValue',
        ),
        3 => array(
            'var' => 'i16Val',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TI16Value',
        ),
        4 => array(
            'var' => 'i32Val',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TI32Value',
        ),
        5 => array(
            'var' => 'i64Val',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TI64Value',
        ),
        6 => array(
            'var' => 'doubleVal',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TDoubleValue',
        ),
        7 => array(
            'var' => 'stringVal',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TStringValue',
        ),
    );

    /**
     * @var \ThriftGenerated\TBoolValue
     */
    public $boolVal = null;
    /**
     * @var \ThriftGenerated\TByteValue
     */
    public $byteVal = null;
    /**
     * @var \ThriftGenerated\TI16Value
     */
    public $i16Val = null;
    /**
     * @var \ThriftGenerated\TI32Value
     */
    public $i32Val = null;
    /**
     * @var \ThriftGenerated\TI64Value
     */
    public $i64Val = null;
    /**
     * @var \ThriftGenerated\TDoubleValue
     */
    public $doubleVal = null;
    /**
     * @var \ThriftGenerated\TStringValue
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->boolVal = new \ThriftGenerated\TBoolValue();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->byteVal = new \ThriftGenerated\TByteValue();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->i16Val = new \ThriftGenerated\TI16Value();
                ...
                case 4:
                    if ($ftype == TType::STRUCT) {
                        $this->i32Val = new \ThriftGenerated\TI32Value();
                ...
                case 5:
                    if ($ftype == TType::STRUCT) {
                        $this->i64Val = new \ThriftGenerated\TI64Value();
                ...
                case 6:
                    if ($ftype == TType::STRUCT) {
                        $this->doubleVal = new \ThriftGenerated\TDoubleValue();
                ...
                case 7:
                    if ($ftype == TType::STRUCT) {
                        $this->stringVal = new \ThriftGenerated\TStringValue();

...
class TTypeEntry
{
    ...
    static public $_TSPEC = array(
        1 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TPrimitiveTypeEntry',
        ),
        2 => array(
            'var' => 'arrayEntry',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TArrayTypeEntry',
        ),
        3 => array(
            'var' => 'mapEntry',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TMapTypeEntry',
        ),
        4 => array(
            'var' => 'structEntry',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TStructTypeEntry',
        ),
        5 => array(
            'var' => 'unionEntry',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TUnionTypeEntry',
        ),
        6 => array(
            'var' => 'userDefinedTypeEntry',
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TUserDefinedTypeEntry',
        ),
    );

    /**
     * @var \ThriftGenerated\TPrimitiveTypeEntry
     */
    public $primitiveEntry = null;
    /**
     * @var \ThriftGenerated\TArrayTypeEntry
     */
    public $arrayEntry = null;
    /**
     * @var \ThriftGenerated\TMapTypeEntry
     */
    public $mapEntry = null;
    /**
     * @var \ThriftGenerated\TStructTypeEntry
     */
    public $structEntry = null;
    /**
     * @var \ThriftGenerated\TUnionTypeEntry
     */
    public $unionEntry = null;
    /**
     * @var \ThriftGenerated\TUserDefinedTypeEntry
     */
            ...
            switch ($fid) {
                case 1:
                    if ($ftype == TType::STRUCT) {
                        $this->primitiveEntry = new \ThriftGenerated\TPrimitiveTypeEntry();
                ...
                case 2:
                    if ($ftype == TType::STRUCT) {
                        $this->arrayEntry = new \ThriftGenerated\TArrayTypeEntry();
                ...
                case 3:
                    if ($ftype == TType::STRUCT) {
                        $this->mapEntry = new \ThriftGenerated\TMapTypeEntry();
                ...
                case 4:
                    if ($ftype == TType::STRUCT) {
                        $this->structEntry = new \ThriftGenerated\TStructTypeEntry();
                ...
                case 5:
                    if ($ftype == TType::STRUCT) {
                        $this->unionEntry = new \ThriftGenerated\TUnionTypeEntry();
                ...
                case 6:
                    if ($ftype == TType::STRUCT) {
                        $this->userDefinedTypeEntry = new \ThriftGenerated\TUserDefinedTypeEntry();

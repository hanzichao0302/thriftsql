...
class BeeswaxServiceClient implements \ThriftGenerated\BeeswaxServiceIf
{
    ...
    public function send_query(\ThriftGenerated\Query $query)
    {
        $args = new \ThriftGenerated\BeeswaxService_query_args();
        $args->query = $query;
    ...
    public function recv_query()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_query_result();
    ...
    public function send_executeAndWait(\ThriftGenerated\Query $query, $clientCtx)
    {
        $args = new \ThriftGenerated\BeeswaxService_executeAndWait_args();
        $args->query = $query;
    ...
    public function recv_executeAndWait()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_executeAndWait_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_explain(\ThriftGenerated\Query $query)
    {
        $args = new \ThriftGenerated\BeeswaxService_explain_args();
        $args->query = $query;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
    ...
    public function recv_explain()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_explain_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_fetch(\ThriftGenerated\QueryHandle $query_id, $start_over, $fetch_size)
    {
        $args = new \ThriftGenerated\BeeswaxService_fetch_args();
    ...
    public function recv_fetch()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_fetch_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_get_state(\ThriftGenerated\QueryHandle $handle)
    {
        $args = new \ThriftGenerated\BeeswaxService_get_state_args();
        $args->handle = $handle;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
    ...
    public function recv_get_state()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_get_state_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_get_results_metadata(\ThriftGenerated\QueryHandle $handle)
    {
        $args = new \ThriftGenerated\BeeswaxService_get_results_metadata_args();
        $args->handle = $handle;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
    ...
    public function recv_get_results_metadata()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_get_results_metadata_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \ThriftGenerated\BeeswaxService_echo_args();
        $args->s = $s;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
    ...
    public function recv_echo()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_echo_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \ThriftGenerated\BeeswaxService_dump_config_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
    ...
    public function recv_dump_config()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_dump_config_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \ThriftGenerated\BeeswaxService_get_log_args();
    ...
    public function recv_get_log()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_get_log_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \ThriftGenerated\BeeswaxService_get_default_configuration_args();
    ...
    public function recv_get_default_configuration()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_get_default_configuration_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    public function send_close(\ThriftGenerated\QueryHandle $handle)
    {
        $args = new \ThriftGenerated\BeeswaxService_close_args();
        $args->handle = $handle;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
    ...
    public function recv_close()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_close_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->error !== null) {
    ...
    {
        $args = new \ThriftGenerated\BeeswaxService_clean_args();
    ...
    public function recv_clean()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \ThriftGenerated\BeeswaxService_clean_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        return;

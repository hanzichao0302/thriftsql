...
class TCLIService_GetResultSetMetadata_result
{
    ...
    static public $_TSPEC = array(
        0 => array(
            ...
            'isRequired' => false,
            'type' => TType::STRUCT,
            'class' => '\ThriftGenerated\TGetResultSetMetadataResp',
        ),
    );

    /**
     * @var \ThriftGenerated\TGetResultSetMetadataResp
     */
    public $success = null;
            ...
            switch ($fid) {
                case 0:
                    if ($ftype == TType::STRUCT) {
                        $this->success = new \ThriftGenerated\TGetResultSetMetadataResp();
